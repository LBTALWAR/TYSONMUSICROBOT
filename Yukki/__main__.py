...
async def initiate_bot():
    ...
    console.print(
        "[bold green]Congrats!! Tyson Music Bot has started successfully!\n"
    )
    try:
    ...
    if STRING1 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_1.join_chat("TEAM_TYSON")
            await ASS_CLI_1.join_chat("TYSON_SUPPORT_GROUP")
        except:
            pass
    ...
    if STRING2 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_2.join_chat("TEAM_TYSON")
            await ASS_CLI_2.join_chat("TYSON_SUPPORT_GROUP")
        except:
            pass
    ...
    if STRING3 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_3.join_chat("TEAM_TYSON")
            await ASS_CLI_3.join_chat("TYSON_SUPPORT_GROUP")
        except:
            pass
    ...
    if STRING4 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_4.join_chat("TEAM_TYSON")
            await ASS_CLI_4.join_chat("TYSON_SUPPORT_GROUP")
        except:
            pass
    ...
    if STRING5 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_5.join_chat("TEAM_TYSON")
            await ASS_CLI_5.join_chat("TYSON_SUPPORT_GROUP")
        except:
            pass
    ...
    if LOG_SESSION != "None":
        try:
            ...
            return
        try:
            await LOG_CLIENT.join_chat("TEAM_TYSON")
            await LOG_CLIENT.join_chat("TYSON_SUPPORT_GROUP")
        except:
            pass
    console.print(f"└[red] Tyson Music Bot Boot Completed.")
    if STRING1 != "None":
...
home_text_pm = f"""─────「 [{BOT_NAME}](https://telegra.ph/file/feb1a50ba16937e468da6.jpg) 」─────
Hey ! I'm {BOT_NAME} An Advanced Voice + Video Streaming Robot.
───────────────────────
➛ Try The Options Below To Know My Abilities.
"""
